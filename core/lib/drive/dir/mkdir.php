...
class mkdir
{
    ...
    public static function _create_default_ctrl()
    {
        ...
        $data = '<?php'
                    ...
                    .PHP_EOL.'  {'
                    .PHP_EOL.'      echo \'<div style="margin-top:20%;line-height: 4rem;padding: 2rem auto;font-family:黑体;font-size: 1.5rem;border-top:3px solid #6d6d6d;border-bottom:3px solid #6d6d6d;border-radius:8px;white-space:pre-wrap;word-wrap:break-word;letter-spacing:1.5px;text-align:center;">欢迎使用 CORE 框架</div>\'; '
                    .PHP_EOL.'  }'
                    .PHP_EOL.'}';
